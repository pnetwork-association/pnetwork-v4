...
PATH_TEST_WALLET=$PATH_DATA_DIR/test_wallet.pwd
PK_TEST=5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3
NAME_WALLET=test
...
# Create wallet
cleos wallet create -n "$NAME_WALLET" -f "$PATH_TEST_WALLET"

# Import eosio private key
cleos wallet import -n "$NAME_WALLET" --private-key "$PK_TEST"
